...
import static com.wecash.http.utils.DBUtils.queryDataNoConn;


/**
 * @Author: kaka.lo    luoping@***.net
 * @Date: 2019/7/24 6:02 PM
 * @Update:
 * @Conment: 公共工具,针对部分集合数据处理
 * @Other:
 */
@Slf4j
public class ComUtils {
     ...
     * @param jsonA1 JSONArray
     * @param jsonA2 JSONArray
     * @param key    JSONArray中各字典元素的唯一标识字段
     * @return
     */
